...
//				//log2.Get().Warn("=============removerRoomPlayer==========================", zap.Any("roomId=", room.Id), zap.Any("room.playerInfos=", room.playerInfos.playerInfos))
//			}
//		}
//
//		// 1 找房间
...
//			continue
//		}
//		//log2.Get().Warn("=============MatchInfoPush==========================", zap.Int32("roomId=", room.Id), zap.Uint64("UserId=", info.player.UserId), zap.String("================", "======="))
...
//
//	log2.Get().Info("=============MatchInfoPush====pushRoomInfo=start=====================", zap.Int32("roomId=", room.Id), zap.String("================", "======="))
//	// 8.推送信息
